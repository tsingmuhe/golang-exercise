...
type Greeter interface {
	// Parameters:
	//  - User
	SayHello(user *User) (r *Response, err error)
	// Parameters:
	//  - Uid
...
// Parameters:
//  - User
func (p *GreeterClient) SayHello(user *User) (r *Response, err error) {
...
func (p *GreeterClient) sendSayHello(user *User) (err error) {
...
var SayHelloArgs_User_DEFAULT *User

func (p *SayHelloArgs) GetUser() *User {
	if !p.IsSetUser() {
